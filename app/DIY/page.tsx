...
import { DIY } from '../data/productdata'
          ...
          {DIY.map((item) => (
            ...
            >
              ...
              <div className='h-full rounded-lg overflow-hidden text-center shadow-md hover:shadow-xl transition duration-300'>
                ...
                <Link href={`/DIY/${item.id}`} className='block'>
                  <img
                ...
                <div className='p-5'>
                  <Link href={`/DIY/${item.id}`} className='title-font text-sm font-semibold text-black mb-3 block'>
                    {item.name}
                  </Link>
                </div>
                <WhatsAppButton/>
