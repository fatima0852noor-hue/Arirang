...
import { DIY } from "@/app/data/productdata"; // Data file se DIY array import kiya
...
export default function DIYDetailPage() {
  ...
  // DIY data array mein se product match karna
  const product = DIY.find((item) => item.id === productId);

  if (!product) {
    return (
      <div style={{ padding: "40px", textAlign: "center", fontFamily: "sans-serif" }}>
        <h2>Product Not Found!</h2>
        <Link href="/DIY" style={{ color: "#0070f3" }}>Go back to DIY Collection</Link>
      </div>
    );
  }
  ...
  return (
    <main style={{ maxWidth: "1200px", margin: "0 auto", padding: "40px 20px", fontFamily: "sans-serif" }}>
      ...
      <Link href="/DIY" style={{ textDecoration: "none", color: "#666", display: "inline-block", marginBottom: "30px", fontWeight: "500" }}>
        ← Back to DIY Collection
      </Link>
